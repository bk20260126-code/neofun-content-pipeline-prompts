...
**내부 용어 유출 금지 — `BRAND.md` §5에서 읽는다:**
내부에서만 쓰는 방법론 이름·약어를 공개 글에 그대로 쓰지 않습니다.
`BRAND.md` §5에 내부 용어와 공개용 쉬운 표현이 짝지어 있습니다. 항상 오른쪽을 쓰세요.

**승인된 문장 — `BRAND.md` §4에서 읽는다:**
톤은 설명으로 배우는 게 아니라 예문으로 배웁니다. 작성 전에 §4의 승인 문장을 읽고
